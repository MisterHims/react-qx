...
const Page404Error = () => {
  MetaData("Erreur 404 - myReact", "Demo meta description");
  ...
  return (
    <div className="content errorpage-content">
      <Typography className="error-code" variant="h1" color="error">
        404
      </Typography>
      <Typography className="error-text" variant="h2" color="error">
        {" "}
        Page non trouvée{" "}
      </Typography>
      <Typography>
